...
# Read in results:
m <- read.csv('syntheticTests/outputs/cluster/071419/outputMet.csv')
o <- read.csv('syntheticTests/outputs/cluster/071419/outputOP.csv')
oStates <- read.csv('syntheticTests/outputs/cluster/071419/outputOPStates.csv')
...
load('syntheticTests/syntheticData/07-11/synth_07-11_RATES.RData')
to.keep <- c(1, 2, 8)
...
load('syntheticTests/syntheticData/07-11/initStates_07-11.RData')
...
load('syntheticTests/syntheticData/07-11/synth_07-11_S.RData')
...
load('syntheticTests/syntheticData/07-11/params_07-11.RData')
select.parms <- select.parms[to.keep, ]
select.parms$L <- select.parms$L * 365
select.parms <- as.data.frame(cbind(rep(1:3, 5), melt(select.parms)))
    ...
    for (oev_base in levels(o$oev_base)) {
      for (oev in levels(o$oev_denom)) {
        for (lambda in levels(o$lambda)) {
          ...
          o.temp <- o[o$outbreak == i & o$run == j & o$oev_base == oev_base & o$oev_denom == oev & o$lambda == lambda, ]
          oStates.temp <- oStates[oStates$outbreak == i & oStates$run == j & oStates$oev_base == oev_base & oStates$oev_denom == oev & oStates$lambda == lambda, ]
          
          b <- log(o.temp$R0max - o.temp$R0min); a <- -180
          
          for (country in 1:n) {
            oStates$R0[oStates$outbreak == i & oStates$run == j & oStates$oev_base == oev_base & oStates$oev_denom == oev & oStates$lambda == lambda & oStates$country == countries[country]] <- exp(a * AHpt[, country] + b) + o.temp$R0min
            oStates$beta[oStates$outbreak == i & oStates$run == j & oStates$oev_base == oev_base & oStates$oev_denom == oev & oStates$lambda == lambda & oStates$country == countries[country]] <-
              oStates$R0[oStates$outbreak == i & oStates$run == j & oStates$oev_base == oev_base & oStates$oev_denom == oev & oStates$lambda == lambda & oStates$country == countries[country]] / o.temp$D
            oStates$Re[oStates$outbreak == i & oStates$run == j & oStates$oev_base == oev_base & oStates$oev_denom == oev & oStates$lambda == lambda & oStates$country == countries[country]] <-
              oStates$R0[oStates$outbreak == i & oStates$run == j & oStates$oev_base == oev_base & oStates$oev_denom == oev & oStates$lambda == lambda & oStates$country == countries[country]] *
              oStates$S[oStates$outbreak == i & oStates$run == j & oStates$oev_base == oev_base & oStates$oev_denom == oev & oStates$lambda == lambda & oStates$country == countries[country]]
          }
      ...
      for (oev in levels(oStates.err$oev_denom)) {
        for (lambda in levels(oStates.err$lambda)) {
          ...
          for (count.index in 1:n) {
            oStates.err.temp <- oStates.err[oStates.err$outbreak == outbreak & oStates.err$run == run & oStates.err$oev_base == oev_base & oStates.err$oev_denom == oev & oStates.err$lambda == lambda & oStates.err$country == countries[count.index], ]
