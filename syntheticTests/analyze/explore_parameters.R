...
pdf('syntheticTests/outputs/explore/param_explore_1D.pdf', width = 17, height = 12)
...
pdf('syntheticTests/outputs/explore/param_explore_2D.pdf', width = 20, height = 12)
...
# 3D:
pdf('syntheticTests/outputs/explore/param_explore_3D.pdf', width = 21, height = 7)
