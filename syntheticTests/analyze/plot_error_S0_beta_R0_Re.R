...
o <- read.csv('syntheticTests/outputOPParams_SYNTH_highR0mx.csv')
oStates <- read.csv('syntheticTests/outputOP_SYNTH_beta-R0-Re_highR0mx.csv')
...
pdf('syntheticTests/outputs/errors_S_beta_R0_Re_highR0mx.pdf', width = 14, height = 11)
