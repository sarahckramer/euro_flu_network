...
p1 <- ggplot(data = o.plot, aes(x = week, y = D, group = run)) + geom_line(col = 'gray70') + geom_point(size = 0.7, col = 'gray70') +
...
# print(p1)
p2 <- ggplot(data = o.plot, aes(x = week, y = R0mx, group = run)) + geom_line(col = 'gray70') + geom_point(size = 0.7, col = 'gray70') +
...
# print(p2)
p3 <- ggplot(data = o.plot, aes(x = week, y = R0diff, group = run)) + geom_line(col = 'gray70') + geom_point(size = 0.7, col = 'gray70') +
