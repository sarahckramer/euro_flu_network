...
if (outputPlots) {
  pdf('code/gridSearch/plots/comp_byPred_ALL_INDIV.pdf', width = 14, height = 9)
...
if (outputPlots) {
  pdf('code/gridSearch/plots/comp_byObs_ALL_INDIV.pdf', width = 14, height = 9)
...
# Plot MAEs:
if (outputPlots) {
  pdf('code/gridSearch/plots/comp_MAE_ALL_INDIV.pdf', width = 14, height = 9)
...
if (outputPlots) {
  pdf('code/gridSearch/plots/comp_logScores_byPred_ALL_INDIV.pdf', width = 14, height = 9)
  byWeek <- 'Predicted'
  source('code/gridSearch/comp_netVsIndiv/plot_logScores.R')
  dev.off()
  pdf('code/gridSearch/plots/comp_logScores_byObs_ALL_INDIV.pdf', width = 14, height = 9)
  byWeek <- 'Observed'
  source('code/gridSearch/comp_netVsIndiv/plot_logScores.R')
  dev.off()
} else {
...
rm(d, e.pi.list, e.wks.list, byWeek)
