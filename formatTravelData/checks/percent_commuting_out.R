...
c <- c[, 13:15]
write.csv(c, file = 'formatTravelData/formattedData/commuting_number-out_05-07.csv', row.names = FALSE)

res.mat <- as.data.frame(cbind(levels(c$country), res.mat))
write.csv(res.mat, file = 'formatTravelData/formattedData/commuting_prop-foreign_05-07.csv', row.names = FALSE)
