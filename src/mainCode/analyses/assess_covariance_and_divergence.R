...
# Limit S, I, newI to "main" compartments, and specify by country:
...
# Combine over all countries, since no clear patterns by country:
...
# p1
ggsave(filename = 'results/plots/FigS3.svg', plot = p1, width = 10, height = 11)
...
# p1
# similar patterns by country and (sub)type

# Get mean/median/CIs across all countries:
get_quantiles <- function(dat, parm) {
...
# definitely much less than the network model

# grid.arrange(p1, p2, ncol = 1)
ggsave(filename = 'results/plots/FigS2.svg', plot = arrangeGrob(p1, p2, ncol = 1), width = 5.75, height = 7)
