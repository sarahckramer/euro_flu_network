# EAKF mainCode for forecasting and fitting isolated models to observations #

import pandas as pd
from run_models.SIRS_ISOLATED import *
from run_models.functions_all import *


# EAKF mainCode for isolated models (forecasting)
...
def EAKF_fn_ISOLATED(num_ens, tm_step, init_parms, obs_i, ntrn, nsn, obs_vars, tm_ini, tm_range,
    ...
    H = 6  # 7 in R, but remember python_init indexes differently
...
# EAKF mainCode for isolated models (fitting only)
