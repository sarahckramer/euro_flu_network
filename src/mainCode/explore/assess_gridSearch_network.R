### Old mainCode, but allows quick assessment of results of a grid search, exploring different oev_denom/lambda values ###
...
# Allows use of existing quick-plot mainCode:
m$model <- m$oev_base
