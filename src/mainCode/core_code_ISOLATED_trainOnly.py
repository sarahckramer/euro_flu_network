# Code to run through all countries, seasons, and (sub)types and FIT isolated models to observations (no forecasting) #
    ...
    for season_index in range(len(seasons)):
        ...
        if any(obs_i > 0) and not obs_i.isnull().all():
            ...
            for run in range(num_runs):
                ...
                outputOP_temp = res[0]
                outputCorr_temp = res[1]
                outputRat_temp = res[2]
